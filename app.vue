        ...
        r = {
              ...
              function r(t, r, n, c, u) {
                ...
                function nrWrapper() {
                  ...
                  try {
                    ...
                    (t.isLongTask && i("long-task", [t, a], l, u),
                      i(r + "end", [o, a, f], l, u));
                  }
                }
              }
          ...
          6154: (e, t, r) => {
            ...
            const i = "undefined" != typeof window && !!window.document,
              ...
              f = (() => {
                const e = s.navigator?.userAgent?.match(
                  /Firefox[/\s](\d+\.\d+)/
                );
        ...
        (() => {
          ...
          var t = (t, r) => {
              ...
              for (t && t(r); u < s.length; u++)
                ((o = s[u]), i.o(e, o) && e[o] && e[o][0](), (e[o] = 0));
            },
            r = (self["webpackChunk:NRBA-1.303.0.PROD"] =
              self["webpackChunk:NRBA-1.303.0.PROD"] || []);
        ...
        (() => {
            ...
            constructor(e) {
              (super(e, P.T),
                y.RI &&
                  ((0, N.u)(
                    () =>
                      (0, a.p)("docHidden", [(0, c.t)()], void 0, P.T, this.ee),
                    !0
                  ),
                  (0, I.sp)("pagehide", () =>
              ...
              return (
                (t.sameOrigin ||
                  ...
                  (u.traceContextStateHeader =
                    this.generateTraceContextStateHeader(s, c, n, i, o))),
                ...
                (function (e, t, r, i) {
                  ...
                  function E(e) {
                    ...
                    if (!this.ended) {
                      this.ended = !0;
                      for (let t = 0; t < Te; t++)
                        e.removeEventListener(xe[t], this.listener, !1);
                      t.aborted ||
                        (0, we.iW)(t) ||
                  ...
                  function A(e, r) {
                    ...
                    if (
                      ...
                      e.sameOrigin &&
                        r.getAllResponseHeaders().indexOf(Se) >= 0)
                    ) {
          ...
          class yt extends E {
            ...
            constructor(e) {
              ...
              (this.ee.on(mt, m),
                ...
                u.buffer(
                  ["setTimeout" + lt, "clearTimeout" + dt, mt],
                  this.featureName
                ),
                d.buffer([mt, "new-xhr", "send-xhr" + dt], this.featureName),
                f.buffer(
                  [gt + dt, gt + "-done", gt + ft + dt, gt + ft + lt],
                  this.featureName
                ),
                h.buffer(["newURL"], this.featureName),
                p.buffer([mt], this.featureName),
                s.buffer(
                  ["propagate", vt, ht, "executor-err", "resolve" + dt],
                  this.featureName
                ),
          ...
          class Rt extends E {
            ...
            constructor(e) {
              ...
              let s;
              if (
                (y.RI && o && (me(this.ee), ce(this.ee), (s = Pe(this.ee))),
                y.RI)
              ) {
                if (
                  e.init.user_actions.enabled &&
          ...
          function Et(e, t, r, n) {
            ...
            return (
              Tt.set(a, s),
              o.inPlace(t, [r], "wrap-logger-", () => Tt.get(a)),
              i
            );
          }
          var At = i(1910);
...
const newRelicScript = computed(() => {
  const accountID = config.public.NEW_RELIC_ACCOUNT_ID || "";
  const trustKey = config.public.NEW_RELIC_TRUST_KEY || "";
  const agentID = config.public.NEW_RELIC_AGENT_ID || "";
  const licenseKey = config.public.NEW_RELIC_LICENSE_KEY || "";
  const applicationID = config.public.NEW_RELIC_APPLICATION_ID || "";

  return `window.NREUM||(NREUM={});NREUM.init={distributed_tracing:{enabled:true},performance:{capture_measures:true},browser_consent_mode:{enabled:false},privacy:{cookies_enabled:true},ajax:{deny_list:["bam.nr-data.net"]}};
...
useHead({
  ...
  link: [
    ...
    { rel: "apple-touch-icon", href: "/lenin_profile.jpg" },
  ],
  script: [
    {
